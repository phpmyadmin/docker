...
RUN apk add --no-cache php5-mysqli php5-ctype php5-xml php5-gd php5-zlib php5-bz2 php5-zip php5-openssl php5-curl php5-opcache php5-json nginx php5-fpm supervisor && rm -rf /var/lib/nginx /etc/nginx /etc/init.d /etc/logrotate.d
